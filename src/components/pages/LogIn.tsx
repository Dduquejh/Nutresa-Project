  ...
  return (
    <div className="flex h-screen items-center">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-md flex flex-col items-center"> {/* Ajusta el max-width del formulario */}
      ...
      <div className="w-1/2 flex flex-col justify-center items-center bg-white">
        <img src={GlobeGraphic} alt="Planet Graphic" className="w-4/5 max-w-xs mb-12" /> {/* Ajusta el max-width de la imagen */}
        <img src={CriskAi} alt="CriskAI Logo" className="w-1/3 max-w-xs" /> {/* Ajusta el max-width del logo */}
      </div>
    </div>
  );
};
